...
// string inputValue;                          // Объявление переменной, в которую будем сохранять пользоватльеский ввод
...
//         if (value1 > value2)
//         {
//             Console.WriteLine($"{value1} больше, чем value2}");
//         }
//         else if (value2 > value1)
//         {
//             Console.WriteLine($"{value2} больше, чем {value1}");
//         }
//         else
//         {
//             Console.WriteLine($"{value1} и {value2} равны");
//         }
